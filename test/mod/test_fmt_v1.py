...
class TestFormatV1(unittest.TestCase):
    ...
    def test_format_output(self):
        ...
        description = {
            "pipeline": {"stages": [{"name": "org.osbuild.noop"}, {"name": "org.osbuild.error"}]}
        }
    ...
    def test_validation(self):
                        ...
                        "stages": [
                            {
                                ...
                                "options": {"timeservers": "string"},  # should be an array
                            }
                        ],
                    }
                }
        ...
        assembler_check = {
            "pipeline": {
                "assembler": {"name": "org.osbuild.tar", "options": {"compression": "foobar"}}
            }
        }
