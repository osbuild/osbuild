...
class TestMonitor(unittest.TestCase):
    ...
    def test_log_monitor_no_duration(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert res
            # XXX: depending on the behavior, this test will either test that Duration is not printed,
            # or it will not be necessary if Duration is always printed even when there is no stage.
