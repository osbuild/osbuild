...
from osbuild.util.bom.spdx2.model import (
...
def test_external_package_ref_category_str():
    ...
    assert str(ExternalPackageRefCategory.PACKAGE_MANAGER) == "PACKAGE_MANAGER"
    assert str(ExternalPackageRefCategory.PERSISTENT_ID) == "PERSISTENT_ID"
