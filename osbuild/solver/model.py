    ...
    def __setattr__(self, name: str, value: Any) -> None:
        ...
        if not isinstance(value, expected_types):
            ...
            if isinstance(expected_types, tuple):
                # NB: 't' is a type, not a variable, so we need to use unidiomatic-typecheck.
...
class Repository(ValidatedModel):
    ...
    _ATTR_TYPES = {
        ...
        "metadata_expire": (int, str, type(None)),
    ...
    def __init__(
        ...
        self.metadata_expire: Optional[int] = kwargs.pop("metadata_expire", None)
